...
if(isset($_SESSION['reg_email']['validar'])){
    if($_SESSION['reg_email']['validar'] == false){
        ...
        unset($_SESSION['reg_email']['validar']);
    }
}
?>
<section class="">
    <div class="h1__box">
            <h1 class="poster__description--h1 poster__description--h1--canva h1__cita"><span class="poster__description--span poster__description--h1--canva h1__cita"></span><span class="poster__description--span2 poster__description--h1--canva h1__cita">R</span>egistrate</h1>
    </div>
    <form class="form formdig" action="contenidos/acciones/validar_email.php" method="post">
