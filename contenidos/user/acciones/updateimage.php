<?php
    ...
    if(isset($_SESSION['fotoperfil'])){
        ...
        //echo 'existe session foto';
    }else{
        //echo 'No existe session foto';
    }
    $fotoPortada = $_SESSION['fotoPortada'];
     ...
     $fotoDB = str_replace('contenidos/usuarios/assets/imgPerfil', '', $fotoperfil);
     $fotoDBP = str_replace('contenidos/usuarios/assets/imgPortada', '', $fotoPortada);
     //$fotoDB = $_SESSION['fotoperfil'];
     //$fotoDBP = $_SESSION['fotoPortada'];
     //echo 'fotodb es : ' . $fotoDB;
    unset($_SESSION['fotoperfil']);
    unset($_SESSION['fotoPortada']);
    //echo $_FILES['imagen']['size'][0] . 'maximo: ' . $maximo;
    if(($_FILES['imagen']['size'][0] > $maximo) || ($_FILES['imagen']['size'][1] > $maximo)){
        ...
        if(($_FILES['imagen']['size'][0] > 0) || ($_FILES['imagen']['size'][1] > 0)){
            ...
            if(($_FILES['imagen']['size'][0] > 0)){
                ...
                $upload_diruno = '../../../admin/contenidos/usuarios/assets/imgPerfil/'; // upload directory
                ...
                $path1DBp = 'contenidos/usuarios/assets/imgPerfil/'. $fileImguno;
            ...
            if(($_FILES['imagen']['size'][1] > 0)){
                ...
                $upload_dir2 = '../../../admin/contenidos/usuarios/assets/imgPortada/'; // upload directory 
                $img2Ext = strtolower(pathinfo($imagendos,PATHINFO_EXTENSION)); 
                $fileImg2 = time( ).rand(1,1000).".".$img2Ext;
                $path2DBP = 'contenidos/usuarios/assets/imgPortada/'. $fileImg2;
